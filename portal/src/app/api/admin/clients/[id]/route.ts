...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  if (body.show_creatives_v3 !== undefined) {
    await query('UPDATE clients SET show_creatives_v3 = $1 WHERE id = $2', [!!body.show_creatives_v3, params.id]);
  }

  if (body.enable_cross_account_creative_tagging !== undefined) {
  ...
  if (body.show_insights !== undefined) {
    await query('UPDATE clients SET show_insights = $1 WHERE id = $2', [!!body.show_insights, params.id]);
  }
